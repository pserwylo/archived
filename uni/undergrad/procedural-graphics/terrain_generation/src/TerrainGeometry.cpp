...
double TerrainGeometry::getHeightAt(osg::Vec2 xy)
{
	...
	double a00 = bottomLeft;
	double a10 = bottomRight - bottomLeft;
	double a01 = topLeft - bottomLeft;
	double a11 = bottomLeft - bottomRight - topLeft + topRight;
	...
	// TODO: WTF is this?
	// double height = a00 + a10*percentThroughX + a01*percentThroughY + a11*percentThroughX*percentThroughY;
